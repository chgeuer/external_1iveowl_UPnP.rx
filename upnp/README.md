...
subscriptions, and a Bandit/Plug network dashboard. Run them on the host
network; multicast is commonly unavailable in containers. The supervised
`samples/browser` Mix application remains available for distributed-BEAM
introspection.
